...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, KC_UP,   _______, _______, _______, _______,                        _______, _______, _______, KC_UP,   _______, _______, KC_F12,
    ...
    [_MOUSE] = LAYOUT(
        RESET,   BASE,    ARROW,   EDGE,    _______, _______,                                          _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
        ...
        _______, KC_VOLD, KC_VOLD, KC_MUTE, _______, _______, _______, _______,      _______, _______, AG_NORM, AG_SWAP, _______, _______, _______, _______,
