...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYOUT1] = LAYOUT(
        ...
        KC_CAPS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_VOLU,                          TOGGL2,  KC_SLSH, KC_AMPR, KC_8,    KC_LPRN, KC_PAST, KC_F12,
        _______, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  KC_VOLD,                          _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PLUS, KC_MFFD,
